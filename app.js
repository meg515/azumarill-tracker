...
async function init() {
  ...
  setTimeout(() => autoPopulateEnglishImages(), 250);
}
...
async function updateStorageInfo() {
  const privacyNote = `Your personal collection data is stored locally on this device and isn't uploaded anywhere. To fill missing English card images, the app can contact the Pokémon TCG API using Pokémon/card identifiers only; your ownership, purchase, seller, price, and notes data are not sent with those lookups. Export a backup to keep your data safe.`;
  try {
